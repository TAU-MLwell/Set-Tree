...
if __name__ == '__main__':
    params = {'exp_name': 'strict_num=1_deepsets',
              'seed': 0,
              'type': 'strict',
              'num': 1,
              'normalize': True,
    ...
    log_dir = os.path.join(os.path.abspath('__file__' + '/../'), 'outputs', 'deepsets')
    ...
    for seed in range(params['n_seeds']):
        ...
        # model = DDSInvarianceModelVaryingSizes([params['input_dim'], 50, 100, 50],
        #                            rho=nn.Sequential(nn.Linear(50, 30),
        #                                                       nn.ReLU(inplace=True),
        #                                                       nn.Linear(30, 30),
        #                                                       nn.ReLU(inplace=True),
